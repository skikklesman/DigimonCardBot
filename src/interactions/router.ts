...
// commands and autocomplete by name. Two hard rules (TECH-DESIGN §4):
...
export async function route(
  ...
  // Message components, modals, future interaction types, malformed bodies:
  // we register none of them, so a polite ephemeral note is always safe.
